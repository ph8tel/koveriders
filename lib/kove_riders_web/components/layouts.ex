defmodule KoveRidersWeb.Layouts do
  @moduledoc """
  This module holds layouts and related functionality
  used by your application.
  """
  use KoveRidersWeb, :html
  ...
  def app(assigns) do
    ...
    <header class="navbar bg-base-100 border-b border-base-200 px-4 sm:px-6 lg:px-8">
      <div class="flex-1">
        <.link navigate={~p"/"} class="text-xl font-bold tracking-tight text-primary">
          KoveRiders
        </.link>
      </div>
      <div class="flex-none gap-2">
        ...
        <%= if @current_scope && @current_scope.user do %>
          <.link navigate={~p"/garage"} class="btn btn-ghost btn-sm">
            <.icon name="hero-wrench-screwdriver" class="size-4" /> My Garage
          </.link>
